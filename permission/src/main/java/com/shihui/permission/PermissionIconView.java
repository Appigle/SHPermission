...
public class PermissionIconView extends FrameLayout {
    ...
    public PermissionIconView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PermissionIconView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setStyleId(int styleId) {
        ...
        if (itemTextColor != 0)
            ((PermissionIconListAdapter) mGvPermission.getAdapter()).setTextColor(itemTextColor);
    ...
    public void setFilterColor(int color) {
        ...
        ((PermissionIconListAdapter) mGvPermission.getAdapter()).setFilterColor(color);
    }
}
